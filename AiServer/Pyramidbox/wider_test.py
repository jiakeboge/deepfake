...
parser.add_argument('--model', type=str,
                    default="/data/faceDet/FDDB/weights/pyramidbox_120000_99.02.pth", help='trained model')
...
def get_data():
    ...
    if subset == 'val':
        wider_face = sio.loadmat(
            '/data/faceDet/wider_face/wider_face_split/wider_face_val.mat')
    else:
        wider_face = sio.loadmat(
            '/data/faceDet/wider_face/wider_face_split/wider_face_test.mat')
    ...
    save_path = '/data/faceDet/wider_face/pyramidbox_{}'.format(subset)
