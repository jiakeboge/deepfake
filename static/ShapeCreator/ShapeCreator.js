...
class CreaAnnoKeypointImage extends CreaAnno{
    constructor(AnnoType, Data, Stage, Layer, ShowClass) {
...
class VisualizatorKeypointImage extends Visualizator{
    ...
    CreateButton(id){
        ...
        let rectButton = document.createElement("button");
        rectButton.setAttribute('class',"list-group-item list-group-item-action");
        ...
        // if click on empty area - remove all selections
            ...
            if (e.target.getClassName() === 'Rect') {
                if (this.SelectedRect === e.target){
                    ...
                    this.ShowClass.CreaKeypoint(group, xCoordinate, yCoordinate, 3, this.ShowClass.ColorSet[keypointId], keypointId);
                ...
                this.ActiveButton = document.getElementsByName(e.target.getAttr('name'))[0];
